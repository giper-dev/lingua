...
declare namespace $ {
	...
	type $mol_button_minor__hint_hd_linguist_app_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_hd_linguist_app_2 = $mol_type_enforce<
		ReturnType< $hd_linguist_app['clear'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_hd_linguist_app_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_link_source__uri_hd_linguist_app_4 = $mol_type_enforce<
		string
		,
	...
	>
	type $mol_page__title_hd_linguist_app_58 = $mol_type_enforce<
		ReturnType< $hd_linguist_app['title'] >
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__tools_hd_linguist_app_59 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['tools'] >
	>
	type $mol_page__foot_hd_linguist_app_60 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['foot'] >
	>
	type $mol_page__Body_hd_linguist_app_61 = $mol_type_enforce<
		ReturnType< $hd_linguist_app['Body'] >
		,
		ReturnType< $mol_page['Body'] >
	>
	export class $hd_linguist_app extends $mol_book2 {
		...
		foreign_translate_activate( next?: ReturnType< ReturnType< $hd_linguist_app['Foreign_translate'] >['event_activate'] > ): ReturnType< ReturnType< $hd_linguist_app['Foreign_translate'] >['event_activate'] >
		...
		native_translate_activate( next?: ReturnType< ReturnType< $hd_linguist_app['Native_translate'] >['event_activate'] > ): ReturnType< ReturnType< $hd_linguist_app['Native_translate'] >['event_activate'] >
